  ...
  return (
    <div className="h-screen bg-[#EFF0EB] flex relative overflow-hidden" style={{fontFamily: "'Saans TRIAL', -apple-system, Roboto, Helvetica, sans-serif"}}>
      ...
      {showMobileMenu && (
        ...
        <div className="absolute bottom-8 relative mt-auto">
          <img
            src={generateAvatarUrl('operator-main')}
            alt="Operator Profile"
            className="w-[34px] h-[34px] rounded-full object-cover"
          />
                    <div className="w-2 h-2 bg-[#2EBA85] rounded-full border border-white absolute top-[25px] left-[25px]"></div>
        </div>
      </div>
            ...
            >
              <div className="flex items-start gap-3">
                <div className="relative flex flex-col">
                  {conv.unread > 0 && (
                    <div className="bg-white border border-[#F1F1F1] rounded-full text-[#484848] text-xs font-semibold leading-[0] z-[100] ml-auto -mr-[6px] -mb-[11px] px-[5px] py-[8px] shadow-[0_0_10px_0_rgba(0,0,0,0.12)]">
                      {conv.unread}
                    </div>
                  )}
                  <img
        ...
        {/* Message Input Area */}
          ...
          >
            ...
            <div className="absolute bottom-[24px] left-[24px] flex gap-2 ml-auto mr-auto mt-0 mb-0">
              ...
              <div className="w-[34px] h-[34px] bg-[#F8F8F7] rounded-[17px] flex items-center justify-center cursor-pointer hover:bg-[#EAEAEA] transition-colors" onClick={() => setShowDashboardEmojiPanel(!showDashboardEmojiPanel)}>
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none">
                ...
                <div className="mt-[30px]">
                  ...
                  >
                    <div>
                      ...
                      <p className="text-[11px] opacity-70 font-light">Responde em minutos</p>
                    </div>
                    <div>
                      <svg width="26" height="26" viewBox="0 0 33 33" fill="none" className="mt-[2px] mr-[11px]">
                  ...
                  <div className="w-[439px] h-[113px] bg-white border-2 border-[#F1F1F1] rounded-[33px] relative" style={{fontFamily: "'Saans TRIAL', -apple-system, Roboto, Helvetica, sans-serif"}}>
                    ...
                    <div className="absolute bottom-[13px] left-[20px] flex gap-2">
                      <div className="w-[34px] h-[34px] bg-[#F8F8F7] rounded-[17px] flex items-center justify-center cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                          <path d="M7.00023 0C5.52332 0 4.32178 1.20157 4.32178 2.67846V11.9475C4.32178 13.0792 5.24255 14 6.37431 14C7.50607 14 8.42684 13.0792 8.42684 11.9475V3.34991C8.42684 2.57534 7.79668 1.94513 7.02205 1.94513C6.24749 1.94513 5.6173 2.57532 5.6173 3.34991V11.4686H6.47444V3.34991C6.47444 3.04798 6.7201 2.80227 7.02208 2.80227C7.32407 2.80227 7.56972 3.04795 7.56972 3.34991V11.9474C7.56972 12.6066 7.03346 13.1428 6.37431 13.1428C5.71516 13.1428 5.17892 12.6066 5.17892 11.9474V2.67846C5.17892 1.6742 5.99595 0.857145 7.00023 0.857145C8.00452 0.857145 8.82155 1.6742 8.82155 2.67846V11.4686H9.67869V2.67846C9.67869 1.20157 8.47715 0 7.00023 0Z" fill="black"/>
                        </svg>
                      </div>
